...
//            init_pair(20, COLOR_BLUE, COLOR_BLACK); // A default Background Color
            ...
            if(input [(i*l_width) + j] == ' ' || j == l_width - 1){
                m_display.push_back(_SharedPtr<GraphChartPoint>(new GraphChartPoint(j, i, 1, " ")));
            }
            else{

                
                m_display.push_back(_SharedPtr<GraphChartPoint>(new GraphChartPoint(j, i, 1, output)));
            }
