...
{
private:
    TerosObject chest; //Declaring an R3Object within the TreasureChest class template to hold the dynamic, instantaneous 3D data for our whole TreasureChest object.
    TerosObject lid; //Declaring another R3Object to hold the static 3D data for the lid of the chest--the moving component of this advanced 3D object.
...
public:
    ...
    TerosObject * putchest (); //Prototyping a function for returning a pointer to the 'chest' R3Object contained within a given TreasureChest object.
    TerosObject * putlid (); //Prototyping a function for returning a pointer to the 'lid' R3Object contained within a given TreasureChest object.
